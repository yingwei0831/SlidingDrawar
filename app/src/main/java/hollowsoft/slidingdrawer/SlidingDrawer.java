...
import comyingwei0831.github.testslidingdrawar.R;
...
public class SlidingDrawer extends ViewGroup {
    ...
    private  int wholeViewHeight; //整个视图的高度
   ...
   /*新添加的方法，请使用该方法获取整个视图的高度，方便计算其topOffset*/
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        Log.i("Tag", widthSpecSize+", "+heightSpecSize);
        measureChild(viewHandle, widthMeasureSpec, heightMeasureSpec);
        measureChild(viewContent, widthMeasureSpec, heightMeasureSpec);

        /*获取内容视图的高度，真的很蛋疼啊 ，要这样获取，无天理啊 */
        int heightHandle  =  viewHandle.getMeasuredHeight();
        int heightContent = viewContent.getMeasuredHeight();
        this.wholeViewHeight = heightContent + heightHandle;
        if (vertical) {
